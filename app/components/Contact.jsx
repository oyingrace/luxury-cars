            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-amber-400 focus:outline-none transition-colors"
                    placeholder="John"
                  />
                </div>
                <div>
              ...
              <div>
                <label className="block text-gray-300 mb-2 font-medium">Preferred Vehicle</label>
                <select className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-amber-400 focus:outline-none transition-colors">
              ...
              <div>
                ...
                <textarea 
                  rows="4" 
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-amber-400 focus:outline-none transition-colors resize-none"
              ...
              <button 
                type="submit"
                className="w-full bg-amber-400 text-black py-4 rounded-lg font-semibold hover:bg-amber-500 transition-colors duration-300 flex items-center justify-center space-x-2"
              >
                <Send size={20} />
          ...
          >
            ...
            <div className="space-y-6">
              {contactMethods.map((method, index) => (
                <div 
                  key={index}
                  className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-amber-400/50 transition-all duration-300"
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-amber-400 font-medium mb-3">{method.value}</p>
                      <button className="text-white hover:text-amber-400 transition-colors font-medium">
                        {method.action} →
                      </button>
                    </div>
                  </div>
