...
export default function Footer() {
  ...
  return (
    <footer className="bg-black border-t border-gray-800" ref={ref}>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="text-1xl font-bold text-amber-400 mb-6">
                LUXURY RENTALS
              </div>
              <p className="text-gray-400 mb-6 leading-relaxed">
                The UK's premier luxury car rental service, providing access to 
                the world's most exclusive vehicles with unmatched service and 
                attention to detail.
              </p>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <button
                    key={index}
                    className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:bg-amber-400 hover:text-black transition-all duration-300"
                    title={social.name}
                  >
                    <social.icon size={20} />
                  </button>
